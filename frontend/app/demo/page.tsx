  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0a0a0a] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 backdrop-blur-sm md:p-8 fade-up fade-up-delay-1">
          <div className="flex aspect-video w-full items-center justify-center rounded-xl border border-dashed border-white/20 text-sm text-white/40">
            Demo placeholder
          </div>
        </div>
      </div>
