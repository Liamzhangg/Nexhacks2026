          ...
          {flowStep === "result" && previewUrl ? (
            ...
            <div className="flex h-full flex-col px-6 py-6 lg:px-10">
              <div className="mx-auto flex w-full max-w-[96rem] items-center justify-between">
                <button
                  type="button"
                  onClick={() => setFlowStep("edit")}
                  className="rounded-full border border-white/20 bg-white/5 px-4 py-2 text-sm text-white/80 transition hover:border-white/40 hover:text-white"
                >
                  Back
                </button>
                <span className="text-xs uppercase tracking-[0.3em] text-purple-400">Select targets</span>
              </div>
              <div className="mx-auto mt-6 flex w-full max-w-[96rem] flex-1 flex-col overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 backdrop-blur-sm">
            ...
            <>
              <div className="w-full px-4 pt-4 lg:px-10">
                <div className="mx-auto flex w-full max-w-[80rem] flex-col gap-3 rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-transparent px-4 py-3 shadow-[0_20px_40px_-30px_rgba(0,0,0,0.7)] sm:flex-row sm:items-center sm:justify-between backdrop-blur-sm">
              ...
              <div className="mx-auto flex h-full w-full max-w-[80rem] flex-1 flex-col px-6 py-4 lg:px-10">
                ...
                {previewUrl || localVideoUrl ? (
                    ...
                    <source src={previewUrl ?? localVideoUrl ?? undefined} />
                          ...
                          <label className="flex h-full w-full cursor-pointer items-center justify-center rounded-2xl border border-dashed border-white/10 bg-black/40 text-center transition hover:border-white/30">
                            <div className="flex flex-col items-center gap-2 text-white/80">
                              ...
                              <span className="text-lg font-semibold text-white">Click to add footage</span>
                            </div>
                            <input type="file" accept="video/*" className="sr-only" onChange={handleVideoChange} />
                          </label>
                        )}
                  ...
                  <section className="fixed bottom-16 left-0 right-0 z-20">
                    <div className="mx-auto flex h-[90px] w-full max-w-[80rem] px-6 lg:px-10">
                        ...
                        <div className="p-0">
                          {videoDuration ? (
                            <div className="flex flex-col gap-2">
                              ...
                              <div
                                ref={timelineRef}
                                className="relative h-12 overflow-hidden rounded-xl border border-white/10 bg-gradient-to-r from-[#1a1a24] via-[#2a2a2f] to-[#1a1a24]"
                                onPointerMove={(event) => {
                              ...
                              >
                                ...
                                <button
                                  ...
                                  className="absolute top-1/2 z-20 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/80 bg-white shadow"
                                ...
                                />
                                <div className="absolute inset-0 z-0 flex items-end justify-between px-3 pb-2">
                                  {Array.from({ length: Math.min(8, Math.max(4, Math.ceil(videoDuration / 4))) }).map(
                                    (_, index) => (
                                      <div key={index} className="flex flex-col items-center gap-2">
                                        <div className="h-5 w-[2px] rounded-full bg-white/40" />
                                        <span className="text-[9px] text-white/50">
                                          {Math.round(
                                            (videoDuration / Math.min(8, Math.max(4, Math.ceil(videoDuration / 4)))) * index
                                          )}
                                          s
                                        </span>
                                      </div>
